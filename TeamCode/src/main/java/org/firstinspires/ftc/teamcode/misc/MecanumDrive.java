...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.00198584842;
        public double lateralInPerTick = 0.00127172682904237;
        public double trackWidthTicks = 6506.602456723362;

        // feedforward parameters (in tick units)
        public double kS =  1.1273594746010427;
        public double kV = 0.000280253912355625;
        ...
        public double maxAngVel = (Math.PI + (Math.PI/2)); // shared with path
        public double maxAngAccel = (Math.PI + (Math.PI/2));
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // todo: when we have deadwheels set up
