...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 145.19461548875387; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 739.3872652837872; // x position of the perpendicular encoder (in tick units)
    }
